package com.sbnkj.wechatmigrator.service
...
import com.sbnkj.wechatmigrator.core.backup.DirectFileCopyBackupGateway
import com.sbnkj.wechatmigrator.core.model.WechatUserSlot
import com.sbnkj.wechatmigrator.core.sync.WechatFullSyncCoordinator
            ...
            ACTION_START_BACKUP -> {
                ...
                serviceScope.launch {
                    val coordinator = WechatFullSyncCoordinator(
                        ...
                        backupGateway = DirectFileCopyBackupGateway(),
                    )
